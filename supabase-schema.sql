...
-- ============================================================
-- REALTIME — Active la diffusion temps réel entre appareils
-- OBLIGATOIRE pour que la sync multi-appareils fonctionne
-- ============================================================
alter publication supabase_realtime add table public.clients;
alter publication supabase_realtime add table public.timer_sessions;
alter publication supabase_realtime add table public.session_records;

-- Note : participant_scores est propagé via session_records (refetch complet)
-- donc pas besoin de l'ajouter à la publication Realtime.
