...
export const ASSET_TYPE_LABELS: Record<AssetType, string> = {
  compte_bancaire: 'Compte bancaire', livret_epargne: 'Livret / épargne', assurance_vie: 'Assurance Vie',
  actions: 'Actions', etf: 'ETF', crypto: 'Crypto', immobilier: 'Immobilier', vehicule: 'Véhicule',
  objet_valeur: 'Objet de valeur', autre_actif: 'Autre actif', dette: 'Dette',
}

export const ASSET_TYPE_ICONS: Record<AssetType, string> = {
  compte_bancaire: '🏦', livret_epargne: '💰', assurance_vie: '🛡️', actions: '📈', etf: '📊',
