...
import { FileDown, Settings, Map, User, Wallet, Gift, History, Receipt, PieChart } from 'lucide-react'
...
export const MorePage: React.FC = () => {
  ...
  const items = [
    { label: 'Transferts', desc: 'Transferts internes entre comptes et actifs', icon: Receipt, path: '/transactions', color: 'text-cyan-400' },
